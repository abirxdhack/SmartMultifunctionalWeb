...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) === 'xmlhttprequest') {
    ...
    if (!$url) {
        ...
        echo json_encode(['error' => 'Pinterest URL is required']);

        exit;

    }

    $api_url = "https://a360api-c8fbf2fa3cda.herokuapp.com/pnt/dl?url=" . urlencode($url);
    ...
    if ($data && isset($data['media']) && !empty($data['media'])) {

        echo json_encode([

            'status' => isset($data['status']) ? htmlspecialchars($data['status']) : 'success',

            'title' => isset($data['title']) ? htmlspecialchars($data['title']) : 'Unknown Title',

            'media' => array_map(function($item) {

                return [

                    'quality' => isset($item['quality']) ? htmlspecialchars($item['quality']) : 'Unknown',
...
<head>
  ...
  <meta name="description" content="Smart Pinterest Downloader: Download Pinterest videos & images with ease. Developed by Abir Arafat Chawdhury (@ISmartCoder).">

  <meta name="keywords" content="Pinterest Downloader, Pinterest Video Downloader, Pinterest Image Downloader, @ISmartCoder">

  <meta name="author" content="Abir Arafat Chawdhury (@ISmartCoder)">

  <title>Smart Pinterest Downloader</title>
  ...
  <style>
    ...
    .download-button {
      ...
      background: linear-gradient(90deg, #e60023, #c8232c);
...
<body>
  ...
  <header class="text-center py-8 sm:py-16">
    ...
    <img src="https://i.ibb.co/yBNCxwvM/enhanced.png" alt="Smart Pinterest Downloader Logo" class="logo">

    <div class="flex items-center justify-center mt-6 sm:mt-8">

      <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold glow stylish-text mr-4">Smart Pinterest Downloader</h1>
    ...
    <p class="welcome-message mt-3 sm:mt-4 tracking-wide stylish-text text-lg sm:text-xl leading-relaxed max-w-5xl mx-auto">
      ...
      The Ultimate Pinterest Downloader: Download Pinterest videos & images with ease. Built with passion by @ISmartCoder. Still under active development, daily updated by @TheSmartDev.
  ...
  <section id="pnt-downloader" class="section-card max-w-5xl mx-auto">

    <h2 class="text-3xl sm:text-4xl font-semibold text-center mb-8 sm:mb-10 glow stylish-text">Pinterest Downloader</h2>
    ...
    <div class="tool-card">
      ...
      <div class="tool-card-content">
        ...
        <div class="flex justify-center mb-8">
          ...
          <i class="fab fa-pinterest text-6xl text-red-600 animate-pulse"></i>

        </div>

        <h3 class="text-2xl font-bold stylish-text mb-8 text-center">Download Pinterest Media</h3>
        ...
        <div id="form-container" class="mb-8">
          ...
          <div class="grid grid-cols-1 max-w-md mx-auto">
            ...
            <div>
              ...
              <label class="block text-sm font-medium stylish-text mb-3">Pinterest URL</label>

              <input type="url" id="url-input" class="input-field" placeholder="e.g., https://www.pinterest.com/pin/XXXXX/" required>
        ...
        <div class="text-center">
          ...
          <button onclick="downloadPinterest()" class="button font-bold">Download Media</button>
        ...
        <div id="results" class="hidden">
          ...
          <h4 class="text-xl font-bold stylish-text mb-6 text-center">Pin Details</h4>

          <div class="result-box">

            <p><i class="fas fa-check-circle"></i> <strong>Status:</strong> <span id="status"></span></p>

            <p><i class="fas fa-thumbtack"></i> <strong>Title:</strong> <span id="title"></span></p>
  ...
  <footer class="bg-gradient-to-r from-indigo-50 to-purple-50 py-10 sm:py-16 mt-auto">
    ...
    <div class="footer-container max-w-5xl mx-auto text-center">
      ...
      <div class="footer-content">
        ...
        <p class="text-base sm:text-lg font-bold stylish-text">© 2025 Smart Pinterest Downloader. All rights reserved.</p>
  ...
  <script>
    ...
    async function downloadPinterest() {
      ...
      if (!url) {
        ...
        errorEl.textContent = 'Please enter a valid Pinterest URL.';
      ...
      try {
        ...
        if (data.error) {
          ...
          // Show all media (video/image) from response
          ...
          data.media.forEach(item => {
            ...
            if (item.type && item.type.startsWith('video')) {
              ...
              mediaHtml = `<video controls src="${item.url}" style="max-width:100%;border-radius:0.5rem;margin-bottom:1rem;"></video>`;

            } else if (item.type && item.type.startsWith('image')) {

              mediaHtml = `<img src="${item.url}" alt="Pinterest Media" style="max-width:100%;border-radius:0.5rem;margin-bottom:1rem;">`;

            }

            mediaHtml += `<div>

              <a href="${item.url}" class="download-button" target="_blank">Download ${item.quality}</a>
